...
-- [ Open-World Transitions Handler ] --
	...
	if (mainmemory.read_u16_le(StoryFlag) == 0x0001 and mainmemory.read_u16_le(GameState) == 0x8004 and mainmemory.read_u32_le(MenuWindowColor) == 0x00404040) then	--	Shows Seed at Name Entry
		...
		mainmemory.write_u32_le(AyaMenuName3, 0x0000FF07)
...
-- [ Open-World: Central Park ] --
	...
	mainmemory.read_u16_le(StoryFlag) ~= 0x011B then
	...
	if CP == "3" and mainmemory.read_u32_le(Location) == 0xA8067248 and
...
-- [ Open-World: Hospital ] --
	...
	if mainmemory.read_u32_le(Location) == 0xA80281C8 and mainmemory.read_u16_le(StoryFlag) == 0x0220 then															-- Entrance Handler: Subway
...
-- [ GUI: Miscellaneous ] --
	...
	(mainmemory.readbyte(Slot1QuickerSave) == 0x01 or mainmemory.readbyte(Slot2QuickerSave) == 0x01) then
		...
		gui.pixelText(7, 4, "[PER v0.07, Seed:" .. SeedNum .. "] Use L1 or R1 here to change your pixel text font.", "white", "0")
	...
	if (mainmemory.read_u32_le(Location) == 0xA9400048 and mainmemory.readbyte(Slot1QuickerSave) == 0x00) or														-- Clears text for FMV on title screen.
	(mainmemory.read_u32_le(Location) == 0xA9400048 and mainmemory.readbyte(Slot2QuickerSave) == 0x00) or
