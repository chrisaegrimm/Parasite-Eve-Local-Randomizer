...
for line in io.lines("modules/Master_Seed.lua") do
    ...
    if start and line=="" then
        if startwep then
            ...
            temp[3] = math.random(8,8)
            temp[4] = math.random(OffMin,OffMax)
            temp[5] = math.random(10,10)
            temp[6] = math.random(1,1)
            temp[8] = math.random(OffPlusMin,OffPlusMax)
            temp[9] = math.random(0,2)
            temp[10] = math.random(0,0)
...
print("Club Mode Activated\nWeapon Shuffle Complete")
