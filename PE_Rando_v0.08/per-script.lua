...
--	[ Open-World Save-Warp Functionality ] --
	...
	if mainmemory.read_u32_le(Location) == 0xA8002048 or mainmemory.read_u32_le(Location) == 0xA8003148 or mainmemory.read_u32_le(Location) == 0xA80054C8 or		-- Allows a warp-to-map function inside of any allowed save rooms
	mainmemory.read_u32_le(Location) == 0xA8006248 or mainmemory.read_u32_le(Location) == 0xA80072C8 or mainmemory.read_u32_le(Location) == 0xA80083C8 or
	mainmemory.read_u32_le(Location) == 0xA80093C8 or mainmemory.read_u32_le(Location) == 0xA8021148 or mainmemory.read_u32_le(Location) == 0xA8022348 or
	mainmemory.read_u32_le(Location) == 0xA80622C8 or mainmemory.read_u32_le(Location) == 0xA80261C8 or mainmemory.read_u32_le(Location) == 0xA8027348 or
	mainmemory.read_u32_le(Location) == 0xA8028248 or mainmemory.read_u32_le(Location) == 0xA8046348 or mainmemory.read_u32_le(Location) == 0xA8029348 or
	mainmemory.read_u32_le(Location) == 0xA80433C8 or mainmemory.read_u32_le(Location) == 0xA8023448 or mainmemory.read_u32_le(Location) == 0xA8064048 then
	...
	if mainmemory.read_u32_le(Location) == 0xA8004148 or mainmemory.read_u32_le(Location) == 0xA80094C8 then														-- Provides a message for any save room NOT eligible for save-warping
...
-- [ Open-World Transitions Handler ] --
	...
	if (mainmemory.read_u16_le(StoryFlag) == 0x0001 and mainmemory.read_u16_le(GameState) == 0x8004 and mainmemory.read_u32_le(MenuWindowColor) == 0x00404040) then	--	Shows Seed at Name Entry
		...
		mainmemory.write_u32_le(AyaMenuName3, 0x0000FF08)
...
-- [ Open-World: N.Y.P.D. #17 ] --
	...
	if PD == "3" and mainmemory.read_u16_le(StoryFlag) == 0x00B8 and mainmemory.read_u32_le(Location) == 0xA80041C8 then											-- PD Story Flag 4: 1st Visit Complete
	...
	if PD == "6" and mainmemory.read_u16_le(StoryFlag) == 0x0190 then																								-- PD Story Flag 6: RIP Torres...
		...
		console.writeline("[PD = 6] RIP Torres...")
		PD = "7"
	...
	if (mainmemory.read_u32_le(Location) == 0xA80040C8 or mainmemory.read_u32_le(Location) == 0xA80043C8) and														-- Edits Press Conference Event Skip to look less wonky
	(mainmemory.read_u16_le(StoryFlag) == 0x00A4 or mainmemory.read_u16_le(StoryFlag) == 0x00B8) and mainmemory.readbyte(EventSkip) == 0x04 then

		mainmemory.writebyte(EventSkip, 0x06)

	end


	if mainmemory.read_u32_le(Location) == 0xA8004148 and mainmemory.read_u16_le(StoryFlag) == 0x00B8 and mainmemory.readbyte(EventSkip) == 0x06 then				-- Restores Event Skip After Press Conference Fixed Event Skip
	...
	if PD == "7" and mainmemory.read_u32_le(Location) == 0xA8065148 then																							-- Skips Day 4 title card
...
-- [ Open-World: Hospital ] --
	...
	if SW == "0" and mainmemory.read_u32_le(Location) == 0xA80280C8 then
...
-- [ GUI: Miscellaneous ] --
	...
	(mainmemory.readbyte(Slot1QuickerSave) == 0x01 or mainmemory.readbyte(Slot2QuickerSave) == 0x01) then
		...
		gui.pixelText(7, 4, "[PER v0.08, Seed:" .. SeedNum .. "] Use L1 or R1 here to change your pixel text font.", "white", "0")
...
-- [ Equippable Stat Modifications ] --
	...
	if mainmemory.read_u16_le(StoryFlag) == 0x0000 and mainmemory.readbyte(ActiveSaveMenu) ~= 0x00 then
		...
		mainmemory.writebyte(InfSuperJunk, 0x14)
